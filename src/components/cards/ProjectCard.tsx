...
function ProjectCard({ project }: Props) {
  ...
  return (
    ...
    //   <div className="flex space-x-[30px]   lg:space-x-0 lg:absolute lg:top-0 lg:flex-col lg:gap-y-[60px] lg:bg-black lg:bg-opacity-80 lg:justify-center lg:items-center lg:w-full lg:h-[79%]">
    //     <Button type="link" href={project.livePage}>
    //       View Project
    //     </Button>
    //     <Button type="link" href={project.codePage}>
