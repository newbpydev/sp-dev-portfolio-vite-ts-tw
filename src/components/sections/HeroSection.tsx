...
function HeroSection() {
  // @ Output
  return (
    <section className="relative flex flex-col -z-10 items-center justify-center mb-24 -mt-32 md:flex-row md:mt-0 md:mb-[60px] md:justify-start section-container hero-bg-image">
      {/* <div
